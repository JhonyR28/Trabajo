...
#%%
#Ahora muy bien al ser el modelo de suavizado triple con tendencias estacionales el más preciso pasaremos a la parte de predicción donde tomaremos los primeros 4(2017-2020) años como data de entrenamiento para tener pronósticos para la data del 2021
